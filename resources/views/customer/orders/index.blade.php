...
@section('title', 'My Orders - OMS Store')
            ...
            <div class="lg:flex lg:items-start lg:space-x-8">
                ...
                <aside class="hidden lg:block w-64 flex-shrink-0">
                    <nav class="space-y-1">
                        <a href="{{ route('dashboard') }}"
                            class="flex items-center px-4 py-3 text-sm font-bold rounded-xl {{ Route::is('customer.dashboard') ? 'bg-primary-600 text-white' : 'text-gray-600 dark:text-gray-400 hover:bg-white dark:hover:bg-gray-800' }} transition-colors">
                ...
                <div class="flex-1">
                    <div class="mb-8">
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">View and track all your purchases.</p>
                    </div>
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    @forelse($orders as $order)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors">
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-500">{{ $order->items->sum('quantity') }}
                                                items</td>
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <a href="{{ route('customer.orders.show', $order) }}"
                                                    class="inline-flex items-center px-3 py-1.5 border border-primary-600 text-[10px] font-bold rounded-lg text-primary-600 hover:bg-primary-600 hover:text-white transition-colors uppercase tracking-widest">Details</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="6" class="px-6 py-12 text-center text-sm text-gray-500">No orders
                                                found.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
